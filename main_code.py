...
class Entering(Frame):
    def __init__(self, master):
        ...
        #Widgets for framing
        Welcome = Label(self, text = "Welcome to LOVEAT!\n Do you want to Login or Register?"\
...
class Nutri_calc(Frame):
    def __init__(self, master):
        ...
        entryGram.pack()
        # submit
        submit = Button(self, text = "Submit", width = 10, command = on_click)
        submit.pack(padx = 15, pady = 15)
        # output
        label4 = Label(self, text = "These are the nutrition values:", bg="darkturquoise", fg="white")
        label4.pack()
